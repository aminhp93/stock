    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 h-14 flex items-center px-6">
      <div className="w-full max-w-7xl mx-auto flex items-center">
        <nav className="flex items-center gap-2">
          <NavLink to="/data" className={({ isActive }) => getLinkClass(isActive)}>
            <Database size={15} />
            <span>1. Dữ Liệu</span>
          </NavLink>
          <NavLink to="/chart" className={({ isActive }) => getLinkClass(isActive)}>
            <BarChart3 size={15} />
            <span>2. Biểu Đồ</span>
          </NavLink>
          ...
          <NavLink to="/finance" className={({ isActive }) => getLinkClass(isActive)}>
            <Wallet size={15} />
