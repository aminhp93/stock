...
Trước đây script này cào riêng năm 2026 qua thư viện `vnstock` (giá THÔ, chưa
...
if __name__ == "__main__":
    print("⚠️  fetch_vn_stocks_2026.py đã ngừng dùng — chạy đồng bộ FULL (đã điều chỉnh) thay thế.\n")
